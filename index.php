...
//6 khoi dau
	$query1 ="SELECT * FROM posts ORDER BY created_at DESC LIMIT 6,1";
...
//khoi to giua
	$query ="SELECT * FROM posts ORDER BY created_at DESC LIMIT 6,1";
				...
				<div class="row">
					<div class="col-md-8">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="post post-thumb">
									<a class="post-img" href="blog-post.html"><img src="<?php echo("$cate1[thumbnail]") ?>" alt=""></a>
									<div class="post-body">
										<div class="post-meta">
											<a class="post-category cat-3" href="category.html">Jquery</a>
					...
					<?php } ?>
							...
							<div class="col-md-6">
								<div class="post">
									<a class="post-img" href="blog-post.html"><img src="<?php echo" $cate2[thumbnail]" ?>" alt="375" height= "225" "></a>
									<div class="post-body">
										<div class="post-meta">
											<a class="post-category cat-4" href="category.html">Css</a>
											<span class="post-date"><?php echo "$cate2[created_at]"; ?></span>
										</div>
										<h3 class="post-title"><a href="blog-post.html"><?php echo "$cate2[title]"; ?></a></h3>
									</div>
								</div>
							</div>
							<!-- /post -->
